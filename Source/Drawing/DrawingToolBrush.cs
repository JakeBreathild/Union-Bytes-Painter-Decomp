...
public class DrawingToolBrush : DrawingTool
{
	...
	public DrawingToolBrush()
	{
		...
		InputManager.AddKeyBinding(InputManager.KeyBindingsListEnum.TOOL_BRUSH, "BRUSH_SIZE_INCREASE", IncreaseSize, ButtonList.WheelUp, KeyBinding.EventTypeEnum.JUST_PRESSED, shift: false, ctrl: true);
		InputManager.AddKeyBinding(InputManager.KeyBindingsListEnum.TOOL_BRUSH, "BRUSH_SIZE_DECREASE", DecreaseSize, ButtonList.WheelDown, KeyBinding.EventTypeEnum.JUST_PRESSED, shift: false, ctrl: true);
		InputManager.AddKeyBinding(InputManager.KeyBindingsListEnum.TOOL_BRUSH, "BRUSH_BLENDING_INCREASE", IncreaseBlendingStrength, ButtonList.WheelUp, KeyBinding.EventTypeEnum.JUST_PRESSED, shift: false, ctrl: false, alt: true);
		InputManager.AddKeyBinding(InputManager.KeyBindingsListEnum.TOOL_BRUSH, "BRUSH_BLENDING_DECREASE", DecreaseBlendingStrength, ButtonList.WheelDown, KeyBinding.EventTypeEnum.JUST_PRESSED, shift: false, ctrl: false, alt: true);
		InputManager.AddKeyBinding(InputManager.KeyBindingsListEnum.TOOL_BRUSH, "BRUSH_SHAPE", ChangeShape, KeyList.B, KeyBinding.EventTypeEnum.JUST_PRESSED);
		InputManager.AddKeyBinding(InputManager.KeyBindingsListEnum.TOOL_BRUSH, "BRUSH_FALLOFF", ChangeFalloff, KeyList.B, KeyBinding.EventTypeEnum.JUST_PRESSED, shift: false, ctrl: false, alt: true);
	}
	...
	public override void StartDrawing(Vector2i position)
	{
		...
		if (InputManager.CursorSpace == CameraManager.SpaceEnum.PREVIEWSPACE && Register.CollisionManager.CollisionsList.Count > 0)
		{
			previewspacecDrawingPositionLastFrame = new Vector2i(Mathf.FloorToInt(shift + Register.CollisionManager.CollisionsList[0].UV.x * (float)workspace.Worksheet.Data.Width), Mathf.FloorToInt(shift + Register.CollisionManager.CollisionsList[0].UV.y * (float)workspace.Worksheet.Data.Height));
		}
		triangleLastFrame = -1;
	}
